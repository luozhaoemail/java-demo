 ...
 * 	Service方法：
 * 		get/post方式的请求都可以处理，如果servlet中有Service方法，会优先调用service方法对请求进行处理。
 * 	doGet方法：
 * 		处理get方式的请求
 * 	doPost方法：
 * 		处理post方式的请求
 ...
 * 		则service方法处理完后，会再次根据请求方式响应的doGet和doPost方法执行。
		所以，一般情况下，我们是不在覆写的service中调用父类的service方法的，避免出现405错误。
...
public class ServletMethod extends HttpServlet {
	...
	@Override
	protected void service(HttpServletRequest req, HttpServletResponse resp) //tomcat调用时会传入实参对象：req，resp
