...
<script src="${pageContext.request.contextPath}/static/public-js/jquery-1.11.1.min.js"></script>
<STYLE>
body{
	background: #ebebeb;
...
<form action="${pageContext.request.contextPath}/user/login.do" method="post" onsubmit="return checkForm()">
	<DIV style="background: rgb(255, 255, 255); margin: -100px auto auto; border: 1px solid rgb(231, 231, 231); border-image: none; width: 400px; height: 200px; text-align: center;">
		...
		<DIV style="height: 50px; line-height: 50px; margin-top: 30px; border-top-color: rgb(231, 231, 231); border-top-width: 1px; border-top-style: solid;">
			...
			<SPAN style="float: left;">GPS数据实时流同步系统</SPAN> 
...
Copyright © 2017-2018  罗 昭 吕媛媛 张兴
</div>
</body>
</html>