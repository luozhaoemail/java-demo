...
{
	//默认配置
	private static String ip ="172.23.26.86";//在服务器上通过内网访问，使用主机名172.23.26.86或者localhost
	 ...
	 * @return JSONObject
	 */
	public String SocketConnect(String sendCommand) 
	{
	    ...
	    try
	    {
            ...
            System.out.println("检验返回数据到客户端的数据="+jsonString); 
            pw.flush();            
		} 
	    catch (Exception e) 
	    {
