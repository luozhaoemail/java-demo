...
/**
 java -cp $HBASE_HOME/lib/*:test.jar syn.SimpleHbaseAPI
 */
public class SimpleHbaseAPI {
    ...
    public static void init(){
        ...
        conf.set("hbase.zookeeper.quorum",Constant.canalIP);//Constant.canalIP   
        conf.set("hbase.zookeeper.property.clientPort","2181");
        conf.set("zookeeper.znode.parent","/hbase");
        
//		conf.set("hbase.master", "a1:16000");       
...
//      conf.addResource("hdfs-site.xml");
    ...
    public static void createTable(String tableNmae, String[] cols) throws IOException {        
        TableName tbName = TableName.valueOf(tableNmae);
